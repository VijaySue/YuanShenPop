...
Menu::Menu(QWidget* game,QSoundEffect* bgm)
{
    ...
    btn1->setStyleSheet("font:bold 15px; border-image:url("")");
    btn1->setFlat(true);
    btn1->setText("重新开始");
    btn1->resize(70,30);
    btn1->move(0,0);
    ...
    btn2->setStyleSheet("font:bold 15px; border-image:url("")");
    btn2->setFlat(true);
    btn2->setText("关于");
    btn2->resize(60,30);
    btn2->move(75,0);
    ...
    QAbstractButton::connect(btn2,&QPushButton::clicked,game,[=]() {
        ...
        a->setText("作者：Vijay\n联系方式:swj16630122213");
        a->resize(200,150);
        a->setStyleSheet("font:bold 15px;border-image:url(://image/Game.jpg)");
        a->move((screenRect.width()-a->width()) / 2, (screenRect.height()-a->height()) / 2);
        a->show();
    });

    QPushButton* btn3 = new QPushButton(game);
    btn3->setStyleSheet("font:bold 15px; border-image:url("")");
    btn3->setFlat(true);
    btn3->setText("帮助");
    btn3->resize(60,30);
    btn3->move(145,0);
    ...
    btn4->setStyleSheet("font:bold 15px; border-image:url("")");
    btn4->setFlat(true);
    btn4->setText("退出");
    btn4->resize(60,30);
    btn4->move(215,0);
